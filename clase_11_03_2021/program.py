...
while menuValid == 0:
    menu = input("¿Qué desea hacer? ingrese - Fin de semestre(semestre) - matricula(matricula) ")
    if menu == "Semestre" or menu == "semestre":
        ...
        for item in listProgram:
            for b in item:
                ...
                print()
                print("El promedio de notas del programa es:" + aux + "=" + str(coverageProgram))
                
                resultWomenProgram = countWomenProgram(result)
                print("La cantidad de mujeres del programa: " + aux + "=" + str(resultWomenProgram))
                
                resultMenProgram = countMenProgram(result)
                print("La cantidad de hombres del programa: " + aux + "=" + str(resultMenProgram))
                print()
                for promStudent in studentCoverage:
                    print("El estudiante: " + promStudent.get('name') +" ,"+ "del programa:"+promStudent.get("program") + ","+"Tiene un promedio de:"+str(promStudent.get("average")) + ",")
        ...
        if menu == "Matricula" or menu == "matricula":
            ...
            while True:
                ...
                while True:
                    try:
                        newStudent=int(input("Si desea ingresar un nuevo estudiante presione 1 o presione cualquier tecla para salir!!"))  
                        if newStudent < 0:                                  
                            print("Debes escribir un número positivo.")
                        else:
                            break
